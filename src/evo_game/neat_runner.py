...
def run_training(
    ...
    if show_trails is not None:
        app_config.render.show_trails = show_trails
...
def resume_training(
    render: bool = False, config_path: Optional[Path] = None, show_sensors: bool | None = None, show_trails: bool | None = None
) -> None:
